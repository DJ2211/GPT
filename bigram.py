...
# create a set of all unique characters that occur in this text
chars = sorted(list(set(text)))
vocab_size = len(chars)

# create a mappings from characters to integer and vice verse
...
n = int(0.9*len(data)) # first 90% will be train, rest evaluate
train_data = data[:n]
val_data = data[n:]
...
for iter in range(max_iters):
    # evalueate loss on train and val sets
